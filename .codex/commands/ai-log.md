...
### What was asked
A concise summary of what the user asked Codex to do in this session.
...
**Response summary:** (what Codex said or did, including any code generated)

### Design decisions made
Any architectural or implementation choices that were made during the session, and the reasoning behind them.

### Critical evaluation
Identify anything in Codex's output that was:
- Accepted as-is and why
- Modified or corrected, and what changed
- Rejected and why

### Limitations / what Codex got wrong or missed
Honest assessment of gaps or errors in Codex's output this session.
```
